...
public class SearchWeiboUserByOneUidAction extends PshAction{
	
	public SearchWeiboUserByOneUidAction(){
		
		super.code = -1;
		super.name = "SearchWeiboUserByOneUidAction";
...
/*		int count = -1;
		...
		weiboLogin.searchUserByOneUid(uid);
		
		try {
			payload.put("isRun", true);
		} catch (JSONException e) {

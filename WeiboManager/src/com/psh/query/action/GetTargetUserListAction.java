...
public class GetTargetUserListAction extends PshAction{
	...
	public ResponseMessageGenerator handleAction(RequestMessageParser parser) {
		...
		int totalPageNumber = firstPageNumber.getFirstPageNumber("http://m.weibo.cn/searchs/user?q=%E5%9B%9B%E5%B7%9D&page=1");
		System.out.println("------------0级共" + totalPageNumber + "页-----------");
		for(int i = 0 ; i < totalPageNumber ; i++){
			
			GetFirstQueryUser firstQueryUser = new GetFirstQueryUser("http://m.weibo.cn/searchs/user?q=%E5%9B%9B%E5%B7%9D&page=",(i + 1),queryTaskID);
			//查找第一次搜索结果

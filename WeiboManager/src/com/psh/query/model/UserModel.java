...
public class UserModel {
	...
	//指定条件搜索本地获得@的用户名
		public List<UserBean> getUserLocalQuery(Map<String, Object> conditions,int count){

			List<UserBean> userNameList = new ArrayList<UserBean>();
			
			conn = SQLConn.getInstance().getConnection();
			
			String sql = "select uid,nck from wb_user where ";
			...
			try {
				...
				while(rs.next()){
					...
					bean.setUck(rs.getString("nck"));
					userNameList.add(bean);
				}
